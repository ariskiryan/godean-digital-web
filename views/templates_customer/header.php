...
<head>
    ...
    <title>Godean Digital Printing</title>
    ...
    <div class="preloader">
        <div class="preloader-spinner">
            <div class="loader-content">
                <img src="<?php echo base_url()?>assets/assets_shop/img/godean.jpg" alt="godean">
            </div>
        </div>
    </div>
    <!--== Preloader Area End ==-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-left">
                        <i class="fa fa-map-marker"></i> Sidomoyo, Godean, Sleman
                    </div>
                    <!--== Single HeaderTop End ==-->

                    <!--== Single HeaderTop Start ==-->
                    <div class="col-lg-3 text-center">
                        <i class="fa fa-mobile"></i> +62 817 7698 0207
                    </div>
                    <!--== Single HeaderTop End ==-->

                    <!--== Single HeaderTop Start ==-->
                    <div class="col-lg-3 text-center">
                        <i class="fa fa-clock-o"></i> Sen-Min 09.00 - 19.00
                    </div>
                    <!--== Single HeaderTop End ==-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <a href="index2.html" class="logo">
                            <img src="<?php echo base_url() ?>assets/assets_shop/img/godean-logo2.png" alt="godean" class="img-fluid" width="170px">
                        </a>
                    </div>
                    <!--== Logo End ==-->
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <li><a href="<?php echo base_url('customer/data_produk')?>">Produk</a></li>
                                <li><a href="<?php echo base_url('customer/pemesanan')?>">Pemesanan</a></li>
                                <li><a href="<?php echo base_url('register')?>">Register</a></li> 
                                <?php if ($this->session->userdata('nama_pelanggan')) { ?>
                                <li><a href="<?php echo base_url('auth/logout')?>">Hallo, <?php echo $this->session->userdata('nama_pelanggan')?><span> | Logout</span></a></li> 
                                <?php } else { ?>
